...
public class UserControllerblog {
    ...
    public Userblog save(@RequestBody Userblog User){
        ...
        if (matcher.find()) {
            ...
            User.setUrl("https://www.jobberman.com/blog/wp-content/uploads/sites/8/2019/04/Jobberman_Improve_Your_Employee_On-boarding__Jobberman_Improve_Your_Employee_On-boarding_FB.png");
    ...
    public List<Userblog> getAllBlog()  {
        return (List<Userblog>) repository.findblog();
