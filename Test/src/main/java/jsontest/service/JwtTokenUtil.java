...
public class JwtTokenUtil implements Serializable {
	...
	public  final long JWT_TOKEN_VALIDITY = 1000 * 60 * 60;

	@Value("${jwt.secret}")
	private static String secret="akshay";
	...
	public Date getExpirationDateFromToken(String token) {
		System.out.println("expiry check:::"+getClaimFromToken(token, Claims::getExpiration));
...
//		
//		return (Daoservice.check(userDetails) && !isTokenExpired(token));
//	}
}